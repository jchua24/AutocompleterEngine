...
class SimplePrefixTree(Autocompleter):
    ...
    #     #update only once the root is reached
    #     if self.value == []:
    #         self._update_weight()
    ...
    def remove(self, prefix: List) -> None:
        ...
        # # #remove any empty trees created; update only once the root is reached
        self._remove_empty()
        self.sort_subtrees()
...
if __name__ == '__main__':
    ...
    testing_tree.insert("amy", 7.0, ['g', 'a', 'o'])
    ...
    #
    # testing_tree.remove(['s', 'u'])
    # search_results = testing_tree.autocomplete([])
    # print(testing_tree)
    # print(search_results)

    testing_tree.remove(['g', 'a', 'o'])
    search_results = testing_tree.autocomplete([])
    print(testing_tree)
    print(search_results)
    ...
    # test_weight = testing_tree._find_weight(['s', 'u'])
    # print("test weight of non-existent item " + str(test_weight))
